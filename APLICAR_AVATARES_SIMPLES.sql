-- ═══════════════════════════════════════════════════════════════
-- SCRIPT SIMPLES: CRIAR COLUNAS E APLICAR AVATARES
...
DO $$
BEGIN
    -- Adicionar updatedAt em Post (necessário para triggers)
    ...
    -- Adicionar avatarInitialsColor em Post
    ...
    -- Adicionar updatedAt em Comment (necessário para triggers)
    ...
    -- Adicionar avatarImg em Comment
    ...
    -- Adicionar avatarInitialsColor em Comment
