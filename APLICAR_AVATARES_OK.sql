...
-- Compatível com Prisma (camelCase) + Triggers antigos (snake_case)
-- ═══════════════════════════════════════════════════════════════

-- PASSO 1: Adicionar colunas necessárias
DO $$
BEGIN
    -- Post: updated_at (snake_case - APENAS para o trigger não quebrar)
    ...
    -- Post: avatarId (camelCase - padrão Prisma)
    ...
    -- Comment: updated_at (snake_case - APENAS para o trigger não quebrar)
    ...
    -- Comment: avatarId (camelCase - padrão Prisma)
...
-- PASSO 4: Atualizar posts sem avatar
...
-- PASSO 5: Atualizar comentários sem avatar
