...
VALUES (
  ...
  'Barriga Pochete',
  'Discussões sobre postura e barriga projetada',
  '💬',
  '#8B5CF6',
  'postura',
  true,
...
VALUES (
  ...
  'Meia Compressão',
  'Treinar com meia de compressão',
  '💬',
  '#8B5CF6',
  'compressao',
  true,
...
VALUES (
  ...
  'Dor Menstrual',
  'Dor nos nódulos no período menstrual',
  '💬',
  '#8B5CF6',
  'menstrual',
  true,
...
VALUES (
  ...
  'Liberação miofascial para lipedema',
  '💬',
  '#8B5CF6',
  'miofascial',
  true,
...
-- Criar tabela de mensagens (schema corrigido)
