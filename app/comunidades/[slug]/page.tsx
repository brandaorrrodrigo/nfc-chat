...
const MOCK_USER_AVATARS: Record<string, string> = {
  'maria-silva': `https://api.dicebear.com/7.x/lorelei/svg?seed=maria-silva-0&backgroundColor=ffd5dc&gender=female`,
  'ana-costa': `https://api.dicebear.com/7.x/fun-emoji/svg?seed=ana-costa-1&backgroundColor=c7ecee`,
  'juliana-santos': `https://api.dicebear.com/7.x/lorelei/svg?seed=juliana-santos-2&backgroundColor=ffeaa7&gender=female`,
  'dr-carla': `https://api.dicebear.com/7.x/notionists/svg?seed=dr-carla-3&backgroundColor=d1d4f9`,
  'lucas-mendes': `https://api.dicebear.com/7.x/avataaars/svg?seed=lucas-mendes-4&backgroundColor=b6e3f4`,
  'camila-rocha': `https://api.dicebear.com/7.x/lorelei/svg?seed=camila-rocha-5&backgroundColor=c0aede&gender=female`,
  'rafael-costa': `https://api.dicebear.com/7.x/pixel-art/svg?seed=rafael-costa-6&backgroundColor=ffdfbf`,
  'ana-beatriz': `https://api.dicebear.com/7.x/lorelei/svg?seed=ana-beatriz-7&backgroundColor=dfe6e9&gender=female`,
  'jessica-lima': `https://api.dicebear.com/7.x/lorelei/svg?seed=jessica-lima-8&backgroundColor=ffd5dc&gender=female`,
  'bruna-santos': `https://api.dicebear.com/7.x/fun-emoji/svg?seed=bruna-santos-9&backgroundColor=c7ecee`,
  'patricia-alves': `https://api.dicebear.com/7.x/notionists/svg?seed=patricia-alves-10&backgroundColor=ffeaa7`,
  'marina-costa': `https://api.dicebear.com/7.x/lorelei/svg?seed=marina-costa-11&backgroundColor=b6e3f4&gender=female`,
  'joao-pedro': `https://api.dicebear.com/7.x/bottts/svg?seed=joao-pedro-12&backgroundColor=d1d4f9`,
  'amanda-silva': `https://api.dicebear.com/7.x/lorelei/svg?seed=amanda-silva-13&backgroundColor=c0aede&gender=female`,
  'dr-ricardo': `https://api.dicebear.com/7.x/avataaars/svg?seed=dr-ricardo-14&backgroundColor=ffdfbf`,
  'carlos-mendes': `https://api.dicebear.com/7.x/pixel-art/svg?seed=carlos-mendes-15&backgroundColor=dfe6e9`,
  'renata-dias': `https://api.dicebear.com/7.x/lorelei/svg?seed=renata-dias-16&backgroundColor=ffd5dc&gender=female`,
  'pedro-santos': `https://api.dicebear.com/7.x/thumbs/svg?seed=pedro-santos-17&backgroundColor=c7ecee`,
  'ricardo-silva': `https://api.dicebear.com/7.x/avataaars/svg?seed=ricardo-silva-18&backgroundColor=b6e3f4`,
  'juliana-costa': `https://api.dicebear.com/7.x/lorelei/svg?seed=juliana-costa-19&backgroundColor=ffeaa7&gender=female`,
  'marcelo-rocha': `https://api.dicebear.com/7.x/bottts/svg?seed=marcelo-rocha-20&backgroundColor=d1d4f9`,
  'dra-helena': `https://api.dicebear.com/7.x/notionists/svg?seed=dra-helena-21&backgroundColor=c0aede`,
  'fernanda-dias': `https://api.dicebear.com/7.x/lorelei/svg?seed=fernanda-dias-22&backgroundColor=ffd5dc&gender=female`,
  'dr-lucas': `https://api.dicebear.com/7.x/avataaars/svg?seed=dr-lucas-23&backgroundColor=ffdfbf`,
  'thiago-costa': `https://api.dicebear.com/7.x/pixel-art/svg?seed=thiago-costa-24&backgroundColor=c7ecee`,
  'marina-silva': `https://api.dicebear.com/7.x/lorelei/svg?seed=marina-silva-25&backgroundColor=dfe6e9&gender=female`,
  'ricardo-mendes': `https://api.dicebear.com/7.x/thumbs/svg?seed=ricardo-mendes-26&backgroundColor=b6e3f4`,
  'coach-bret': `https://api.dicebear.com/7.x/big-smile/svg?seed=coach-bret-27&backgroundColor=ffeaa7`,
  'julia-santos': `https://api.dicebear.com/7.x/lorelei/svg?seed=julia-santos-28&backgroundColor=c0aede&gender=female`,
  'amanda-costa': `https://api.dicebear.com/7.x/fun-emoji/svg?seed=amanda-costa-29&backgroundColor=ffd5dc`,
  'carla-mendes': `https://api.dicebear.com/7.x/lorelei/svg?seed=carla-mendes-30&backgroundColor=c7ecee&gender=female`,
};
